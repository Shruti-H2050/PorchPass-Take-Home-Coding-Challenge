...
4. Faced challenge with CI Github Actions. As a Cucumber is been used in this project, I have generated the cucumber report which gives clear visualization of 
number of test passed and failed with details of each scenario in a every feature file.Thus the reporter in playwright.config.js file is changed to generate cucumber report instead of default report generated by playwright. Need to add neccessary configuration in playwright.config.js and playwright.yml to make the github actions successful and workflow to pass. I will consider this as enchancement to this project and work accordingly. 
